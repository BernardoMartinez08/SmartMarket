...
using SmartMarket.Infrastructure.DateProvider;
...
public class SalesPointTests
{
    ...
    public void ScanningOneQuantityItem_NoMembershipDeals_ReturnsPricexQuantity()
    {
        ...
        var dateProviderMock = new Mock<FakeNotMondayTuesdayDateProvider>();

        var salesPoint = new SalesPoint(stock, dateProviderMock.Object);
    ...
    */
    ...
    public void ScanningAnItem_OnMondayOrTuesday_ReturnsFivePercentDiscount()
    {
        ...
        var dateProviderMock = new Mock<FakeMondayDateProvider>();
